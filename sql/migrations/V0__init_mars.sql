...
CREATE TABLE `project_daily_info` (
  ...
  `distribute_amount` DECIMAL(30,10) UNSIGNED NOT NULL  DEFAULT '0.00000'COMMENT '当日应分发token数量',
  `actual_distribute_amount` DECIMAL(30,10) UNSIGNED NOT NULL DEFAULT '0.00000' COMMENT '当日实际应分发token数量',
  `tx_user_amount` DECIMAL(30,10) UNSIGNED NOT NULL  DEFAULT '0.00000'COMMENT '当日认购用户数量',
  `actual_tx_user_amount` DECIMAL(30,10) UNSIGNED NOT NULL  DEFAULT '0.00000'COMMENT '当日实际认购用户数量',
